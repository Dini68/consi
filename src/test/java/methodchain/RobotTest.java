...
public class RobotTest {
    ...
    public void testGoAndRotate() {
        ...
        assertEquals(30, robot.getAzimuth());
    }
    ...
    public void testRotate() {
        ...
        //Then
        assertEquals(0, robot.getAzimuth());
    }
...
//    Bónusz feladat tesztje, kommentezd ki az alapfeladathoz
    ...
    public void testNavigationChain() {
        ...
        //Then
        assertEquals("[distance: 5 azimuth: 45, distance: 15 azimuth: 30]", robot.getNavigationList().toString());
    }
}